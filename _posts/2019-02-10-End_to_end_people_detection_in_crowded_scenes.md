...
我们还考虑L_hung的简化版本，其中只有来自C的排名前 $k = \|G\|$ 的预测被考虑用于匹配。 注意，这等效于去除或置零方程2中的成对匹配项o_ij。 我们将此损失表示为L_firstk。 在第4节，我们在实验上比较了L_fix，L_firstk和L_hung，结果显示L_hung效果最好。
